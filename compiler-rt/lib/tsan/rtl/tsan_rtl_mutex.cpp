...
void MutexPreLock(ThreadState *thr, uptr pc, uptr addr, u32 flagz) {
  //Printf("MutexPreLock at addr %p \n", addr);
  //__tsan::instrumentationHookLogMessage("|ACQ ", (void*)addr, thr, pc);
...
void MutexPostLock(ThreadState *thr, uptr pc, uptr addr, u32 flagz, int rec) {
  //Printf("MutexPostLock at addr %p \n", addr);
...
int MutexUnlock(ThreadState *thr, uptr pc, uptr addr, u32 flagz) {
  //Printf("MutexUnlock at addr %p \n", addr);
  //__tsan::instrumentationHookLogMessage("|REL ", (void*)addr, thr, pc);
...
void MutexPostReadLock(ThreadState *thr, uptr pc, uptr addr, u32 flagz) {
  //Printf("MutexPostReadLock at addr %p \n", addr);
...
void MutexReadUnlock(ThreadState *thr, uptr pc, uptr addr) {
 // Printf("MutexReadUnlock at addr %p \n", addr);
...
void MutexReadOrWriteUnlock(ThreadState *thr, uptr pc, uptr addr) {
  //Printf("MutexReadOrWriteUnlock at addr %p \n", addr);
...
void Acquire(ThreadState *thr, uptr pc, uptr addr) {
  //__tsan::instrumentationHookLogMessage("Acquire is invoked", (void*)addr, thr->tid);
  //Printf("Acquire(ThreadState *thr)\n");
  //instrumentationHookLogMessage("__tsan_write1 is invoked", (void*)addr, thr->tid, (uptr)pc);
...
void AcquireGlobal(ThreadState *thr) {
  //Printf("void AcquireGlobal(ThreadState *thr)\n");
...
void Release(ThreadState *thr, uptr pc, uptr addr) {
  //Printf("Release(ThreadState *thr)\n");
